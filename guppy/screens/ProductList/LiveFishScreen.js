  ...
  return (
    <LinearGradient colors={["#141E30", "#243B55"]} style={styles.background}>
      <View style={styles.container}>
        <Text style={styles.title}>Live Fish Collection</Text>
        <Text style={styles.subtitle}>Explore exotic live fish for your aquarium.</Text>
